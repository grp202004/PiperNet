...
const gexfData = fs.readFileSync("src/samples/diseasome.gexf", "utf-8");

const gexfFileOfDiseasome = new File([gexfData], "diseasome.gexf", {
    type: "text/gexf",
});
...
describe("the attribute is undefined", () => {
    describe("test function keyAttribute", () => {
        ...
        test("first key of the keyVauleMap", async () => {
            ...
            State.graph.rawGraph = data.graph;
